    ...
    <div className="sm:flex flex-wrap justify-center items-center text-center gap-8">
      <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-white mt-6  shadow-lg rounded-lg dark:bg-gray-800">
        ...
        <p className="text-md  text-gray-500 dark:text-gray-300 py-4">
          Voyagez au travers de différentes thématiques, à commencer par le
          fonctionnement et anatomie de l’œil humain, l’évolution de la vue et
      ...
      <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 mt-6 sm:mt-16 md:mt-20 lg:mt-24 bg-white shadow-lg rounded-lg dark:bg-gray-800">
        ...
        <p className="text-md text-gray-500 dark:text-gray-300 py-4">
          Découvrez l’œil au fil du temps et des saisons, et revenez
          continuellement sur notre site pour retrouver une partie de votre
          guide de l’œil le moment venu.
        </p>
      </div>
      <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 mt-6  px-4 py-4 bg-white shadow-lg rounded-lg dark:bg-gray-800">
        ...
        <p className="text-md  text-gray-500 dark:text-gray-300 py-4">
          Partagez vos découvertes à vos proches, et faites leur découvrir le
          monde de l’ophtalmologie de la meilleure des manières
        </p>
      </div>
    </div>
  );
