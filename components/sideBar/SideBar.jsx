...
import Translator from "../layout/nav/translator/Translator";
import ToggleDark from "../layout/nav/toggleDark/ToggleDark";
function SideBar({ setOpen }) {
  ...
  return (
    <motion.aside
      ...
      exit="exit"
      animate="show"
      className="h-screen bg-red block z-[100] lg:hidden my-4 ml-4 shadow-lg fixed inset-0 w-full"
    >
      <button
        onClick={() => setOpen(false)}
        className="bg-red-500 inline-block h-8 w-8 absolute top-4 right-8 rounded-lg text-white text-2xl dark:bg-gray-700"
      >
        &times;
      </button>
      <div className="bg-white h-full rounded-2xl dark:bg-gray-700">
        <div className="flex items-center justify-center pt-6">
          <Image
            src="https://draniss.ma/wp-content/uploads/2021/12/Groupe-85.png"
            width="200"
            height="80"
            alt="image"
          />
          ...
          <div>
            <Link href="/">
              ...
              >
                ...
                <span className="mx-4 text-sm font-normal">Accueil</span>
              </a>
            </Link>
            <Link href="/propos">
              <a
              ...
              >
                ...
                <span className="mx-4 text-sm font-normal">à Props De Moi</span>
              </a>
            </Link>
            <Link href="/test">
              <a
              ...
              >
                ...
                <span className="mx-4 text-sm font-normal">Test Online</span>
              </a>
            </Link>
            <Link href="/contact">
              <a
              ...
              >
                ...
                <span className="mx-4 text-sm font-normal">Contactze-moi</span>
              </a>
            </Link>
            <Link href="/questions">
              <a
              ...
              >
                ...
                <span className="mx-4 text-sm font-normal">Questions</span>
              </a>
            </Link>
            <Translator />
            <ToggleDark />
